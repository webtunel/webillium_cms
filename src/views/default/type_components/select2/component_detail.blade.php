...
if ($datatable && isset($form['relationship_table']) && $form['relationship_table']) {
    ...
    if(isset($form['datatable_orig']) && $form['datatable_orig'] != ''){
        ...
        if ($id_value) {
            ...
            $foreignKey2 = CRUDBooster::getForeignKey($datatable_table, isset($form['relationship_table']) ? $form['relationship_table'] : '');
            $ids = DB::table(isset($form['relationship_table']) ? $form['relationship_table'] : '')->where($foreignKey, $id_value)->pluck($foreignKey2)->toArray();
